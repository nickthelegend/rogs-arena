...
|---|---|---|---|
| GET | `/health` | – | `{ ok, mongo, er, programId, arena: { roundId, status: 'idle' \| 'open' \| 'resolved', endTs } \| null, indexer: { enabled, lastSig, lastEventAt }, keeper: { enabled, lastRollSig, lastRollAt } }` |
